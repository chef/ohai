...
Ohai.plugin(:Cloud) do
  ...
  def get_alibaba_values
    @cloud_attr_obj.add_ipv4_addr(alibaba["eipv4"], :public)
    @cloud_attr_obj.add_ipv4_addr(alibaba["private_ipv4"], :private)
    @cloud_attr_obj.local_hostname = alibaba["hostname"]
