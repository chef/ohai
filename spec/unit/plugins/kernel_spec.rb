...
describe Ohai::System, "plugin kernel" do
  ...
  describe "default OS kernel plugin" do
    before(:each) do
    ...
    it_expects_from_mash("kernel", "name", "uname -s", [0, "Darwin\n", ""])
    it_expects_from_mash("kernel", "release", "uname -r", [0, "9.5.0\n", ""])
    it_expects_from_mash("kernel", "version", "uname -v", [0, "Darwin Kernel Version 9.5.0: Wed Sep  3 11:29:43 PDT 2008; root:xnu-1228.7.58~1\/RELEASE_I386\n", ""])
    it_expects_from_mash("kernel", "machine", "uname -m", [0, "i386\n", ""])
    it_expects_from_mash("kernel", "processor", "uname -p", [0, "i386\n", ""])
  end
